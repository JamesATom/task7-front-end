...
export default function CreateTicTacToe() {
    ...
    return (
        <div>
            ...
            <div className='twoGames' id='ticPage'>
                <CssVarsProvider>
                    <main>
                        <Sheet
                            sx={{
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', margin: '20px 0px' }}>
                                <FormControl sx={{ width: '180px' }}>
                                    <Button onClick={handleSubmit} endDecorator={<PlayArrowIcon />} component={Link} to='/playGame' size='sm' disabled={roomFilledOr}>Join a Game</Button>
                                </FormControl>
                            </div>
                        </Sheet>
                    </main>
